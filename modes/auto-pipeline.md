...
1. **Extract form questions**: Use Playwright to navigate to the form and snapshot. If questions can't be extracted, use the generic ones.
2. **Generate answers** following the tone (see below).
3. **Save to the report** as a `## H) Draft Application Answers` section.
...
Log in `data/applications.md` with all columns including Report and PDF set to ✅.
